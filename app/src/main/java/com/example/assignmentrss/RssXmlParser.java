...
public class RssXmlParser {
    ...
    // This method is used to read the feed
    ...
    private Item readItem(XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        return new Item(title, description, link, enclosure, guid, pubDate);
    }
    ...
    private String readEnclosure(XmlPullParser parser) throws IOException, XmlPullParserException {
        ...
        if (tag.equals("enclosure")) {
            if (relType.equals("image/jpeg") || relType.equals("image/png")) {
